...
<body>
    ...
    <form action="cancel" method="get">
		...
		<input name="name" type="text" style="position:absolute; left:460px; top:200px; font-family:courier; font-size: 30px; font-weight: bold; border:5px solid red width:50px; height:30px;" placeholder="输入你要注销的用户的昵称" size="22"required />
