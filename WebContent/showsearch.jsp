...
<body>
   ...
   <form action="search" method="get">
		<input name="name" type="text" style="position:absolute; left:450px; top:220px; font-family:courier; font-size: 30px; font-weight: bold; border:5px solid red width:50px; height:30px;" placeholder="输入你要搜索的用户的昵称" size="22"required />
