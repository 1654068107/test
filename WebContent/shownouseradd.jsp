...
<body>
    <img src="image/1.jpg" width="100%" height="100%" style="z-index:-100;position:absolute;left:0;top:0">
     <form action="nouseradd" method="get">
		<input name="name" type="text" style="position:absolute; left:450px; top:220px; font-family:courier; font-size: 30px; font-weight: bold; border:5px solid red width:50px; height:30px;" placeholder="输入你要添加的用户" size="22"required />
